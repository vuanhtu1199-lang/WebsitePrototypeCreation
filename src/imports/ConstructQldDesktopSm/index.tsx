import svgPaths from "./svg-m4yk4mxz4m";
...
function Text27() {
  return (
    <div className="content-stretch flex flex-[239.688_0_0] flex-col items-center min-w-px px-[28px] py-[14px] relative" data-name="Text">
...
function Button2() {
  return (
    <div className="bg-[#0a1b3a] border border-[#0a1b3a] border-solid col-[1/span_2] content-stretch flex items-center justify-center justify-self-end relative row-5 self-stretch shrink-0 w-[343.688px]" data-name="Button">
      <Text27 />
      <Text28 />
    </div>
  );
...
function Container154() {
  return (
    <div className="content-stretch flex flex-col h-[228px] items-start pt-[80px] relative shrink-0 w-[504.25px]" data-name="Container">
      <Heading16 />
      <ParagraphMargin1 />
      <Container155 />
    </div>
...
function Container182() {
  return (
    <div className="content-stretch flex flex-col h-[34px] items-start pb-[16px] relative shrink-0 w-[343.82px]" data-name="Container">
