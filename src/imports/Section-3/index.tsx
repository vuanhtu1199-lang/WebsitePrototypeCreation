import svgPaths from "./svg-itoddyhktc";
...
function Container5() {
  return (
    <div className="content-stretch flex h-[82px] items-center pt-[28px] relative shrink-0 w-[1167px]" data-name="Container">
      <Container6 />
    </div>
  );
}
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[56px] relative shrink-0 w-full" data-name="Container">
      <ContainerMargin1 />
    </div>
  );
}
...
export default function Section() {
  return (
    <div className="bg-[#0b0c0e] content-stretch flex flex-col items-start py-[100px] relative size-full" data-name="Section">
      <Container />
    </div>
  );
}